    ...
    <div v-else class="user-card" v-for="(user, index) in usersList" :key="user.id">
      <div class="user-info">
        <div class="user-avatar">
          <img src="../../public/images/avatar.png" class="user-avatar-img" alt="user" />
        </div>
        <div class="user-text">
...
export default {
  ...
  computed: {
    ...
    usersListDate() {
      const usersJoinedDates = this.usersList.map(user => new Date(Date.parse(user.date_joined)).toLocaleString());
