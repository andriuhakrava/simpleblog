	...
	<div class="container">
		...
		<form class="form-register" @submit.prevent="sendUserInfoForRegistration">
		    ...
		    <input 	type="text" 
		    				...
		    				:class="{ 'is-invalid': $v.userInfo.username.$error }" 
        ...
        <div class="invalid-feedback" v-if="!$v.userInfo.email.email">
		  ...
		  <div class="form-group">
		    ...
		    <input  type="password" 
		    				...
		    				:class="{ 'is-invalid': $v.userInfo.password1.$error }" 
		    				@blur="$v.userInfo.password1.$touch()" 
		    				required />
        ...
        <div class="invalid-feedback" v-if="!$v.userInfo.password1.minLength">
		  ...
		  <div class="form-group">
		    ...
		    <input  type="password" 
		    				...
		    				:class="{ 'is-invalid': $v.userInfo.password2.$error }" 
		    				@blur="$v.userInfo.password2.$touch()"
		    				required />
